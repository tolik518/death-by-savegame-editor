...
Download for windows [here](https://github.com/tolik518/death-by-savegame-editor/releases/download/0.2.0/dbs-gui.exe)

<img src="/data/images/screenshot.png" alt="Screenshot" height="700">    
...
⚠ YOU CAN GET **BANNED** FROM THE LEADERBOARD FOR USING MODIFIED SAVE FILES IF YOU HAVENT DISABLED THEM IN THE SETTINGS ⚠
